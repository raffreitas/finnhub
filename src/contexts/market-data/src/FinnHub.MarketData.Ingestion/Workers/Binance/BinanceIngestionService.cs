...
using FinnHub.MarketData.Ingestion.Workers.Binance.Models;
...
namespace FinnHub.MarketData.Ingestion.Workers.Binance;

internal sealed class BinanceIngestionService(
    IOptions<BinanceSettings> options,
    ILogger<BinanceIngestionService> logger,
